...
class CreateRequestPayload(primitives.Struct):
    ...
    def read(self, input_buffer, kmip_version=enums.KMIPVersion.KMIP_1_0):
        ...
        Raises:
            ValueError: Raised if the object type or template attribute is
                missing from the encoded payload.
        """
    ...
    def write(self, output_buffer, kmip_version=enums.KMIPVersion.KMIP_1_0):
        ...
        Raises:
            ValueError: Raised if the object type attribute or template
        ...
        if self._template_attribute:
            ...
            raise ValueError(
                "Payload is missing the template attribute field."
            )
...
class CreateResponsePayload(primitives.Struct):
    ...
    def read(self, input_buffer, kmip_version=enums.KMIPVersion.KMIP_1_0):
        ...
        Raises:
            ValueError: Raised if the object type or unique identifier is
                missing from the encoded payload.
        """
    ...
    def write(self, output_buffer, kmip_version=enums.KMIPVersion.KMIP_1_0):
        ...
        Raises:
            ValueError: Raised if the object type attribute or unique
